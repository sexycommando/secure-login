...
/**
 * The {@link TypeHandler} for {@link Blob}/{@link InputStream} using method
 * supported at JDBC 4.0.
 *
 * @since 3.4.0
...
public class BlobInputStreamTypeHandler extends BaseTypeHandler<InputStream> {
    ...
    /**
     * Get an {@link InputStream} that corresponds to a specified column name
     * from {@link ResultSet}.
     *
    ...
    /**
     * Get an {@link InputStream} that corresponds to a specified column index
     * from {@link ResultSet}.
     *
